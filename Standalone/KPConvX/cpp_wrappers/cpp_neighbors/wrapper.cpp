...
static char module_docstring[] = "This module provides two methods to compute radius/knn neighbors from pointclouds or batch of pointclouds";

static char batch_radius_query_docstring[] = "Method to get radius neighbors in a batch of stacked pointclouds";

static char batch_knn_query_docstring[] = "Method to get knn neighbors in a batch of stacked pointclouds";


// Declare the functions
// *********************

static PyObject *batch_radius_neighbors(PyObject *self, PyObject *args, PyObject *keywds);
static PyObject *batch_knn_neighbors(PyObject *self, PyObject *args, PyObject *keywds);
...
{
	{ "batch_radius_neighbors", (PyCFunction)batch_radius_neighbors, METH_VARARGS | METH_KEYWORDS, batch_radius_query_docstring },
	{ "batch_knn_neighbors", (PyCFunction)batch_knn_neighbors, METH_VARARGS | METH_KEYWORDS, batch_knn_query_docstring },
	{NULL, NULL, 0, NULL}
};
...
PyMODINIT_FUNC PyInit_cpp_neighbors(void)
{
    import_array();
